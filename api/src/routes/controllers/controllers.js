...
const getPokemonsByID = async (id) => {
    ...
    if(!pokemonById) throw new Error("No existe ningun pokemon con ese id");
    return pokemonById;
} 
...
const getPokemonsByName = async (name) => {
    ...
    if(!pokemonByName) throw new Error("No existe ningun pokemon con ese nombre, volver a buscar");
...
const detelePokemon = async (id) => {
    ...
    return `${pokemon.name} fue eliminado`;
}
